...
//    $user_password = crypt($user_password, $randSalt);
    ...
    if($user_password){
        $user_passwordn=md5($user_password);
        $uppass= "UPDATE user_password='$user_passwordn' WHERE user_id =$edit_id";
        mysqli_query($connection,$query);
    }
    $query = "UPDATE users SET  user_firstname ='$user_firstname',user_lastname = '$user_lastname',user_image='$user_image',user_email='$user_email',user_role ='$user_role' WHERE user_id =$edit_id ";
