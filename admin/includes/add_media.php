<?php
    ...
    **/ 
    ...
    move_uploaded_file($tmp_post_image, "../images/mediaroom/$post_image");
    }
	...
	if($post_id){
        $metaquery="INSERT INTO metainfo SET post_id='".media.$post_id."',url='".$post_name."',metatitle='".$metatitle."',metadescription='".$metadescription."'";
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
       <label for="post_image">Post Hero Image</label>
        <input type="file" name="post_hero_image">
    </div>
